CREATE TABLE [covid].[SARS2_INCIDENT] (
...
GO
CREATE NONCLUSTERED INDEX [IX_Covid_Sars2Incident_DateLastEdited]
    ON [covid].[SARS2_INCIDENT]([Date_Last_Edited] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Covid_Sars2Incident_CreateDate]
    ON [covid].[SARS2_INCIDENT]([PR_CREATEDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Covid_Sars2Incident_IncidentId]
    ON [covid].[SARS2_INCIDENT]([PR_INCIDENTID] ASC);
