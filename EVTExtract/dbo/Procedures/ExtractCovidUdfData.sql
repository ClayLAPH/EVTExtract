create procedure dbo.ExtractCovidUdfData 
  @isRestart tinyint = 0
as
begin
  ...
  begin try
    ...
    truncate table dbo.COVID_UDF_DATA;
    insert dbo.COVID_UDF_DATA 
    (       
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractCovidUdfData @isRestart = 1;
  end
