create procedure dbo.ExtractCovidIncidentPersonalRecord
  @isRestart tinyint = 0
as
begin
  ...
  set nocount on;
  declare 
    @name sysname = 'i.covid.incidentpersonalrecord',
  ...
  insert internals.covidpersonalrecord
  (
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractCovidIncidentPersonalRecord @isRestart = 1;
  end
