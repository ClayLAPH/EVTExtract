create procedure dbo.ExtractCovidOutbreak
  @isRestart tinyint = 0
as
begin
  ...
  begin try
    ...
    truncate table dbo.COVID_OUTBREAK;
    insert dbo.COVID_OUTBREAK 
    (
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractCovidOutbreak @isRestart = 1;
  end
