create procedure dbo.ExtractCovidPerson  
  @isRestart tinyint = 0
as
begin
  ...
  begin try
    truncate table dbo.COVID_PERSON;
    insert dbo.COVID_PERSON
    (
    ...
    execute dbo.ExtractPersonInPieces 543030;
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractCovidPerson @isRestart = 1;
  end
