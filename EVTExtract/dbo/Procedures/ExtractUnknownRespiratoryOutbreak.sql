create procedure dbo.ExtractUnknownRespiratoryOutbreak
  @isRestart tinyint = 0
as
begin
  ...
  set nocount on;
  declare 
    @name sysname = 'UNKNOWN_RESPIRATORY_OUTBREAK',
  ...
  begin try
    select @rows = count(*) from dbo.UNKNOWN_RESPIRATORY_OUTBREAK;
    select @status = 'ends';
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractUnknownRespiratoryOutbreak @isRestart = 1;
  end
