create procedure dbo.ExtractCovidIncident 
  @isRestart tinyint = 0
as
begin
  ...
  begin try
    execute dbo.ExtractCovidIncidentInPieces2;
    select  @status = 'ends', @rows = count(*) from dbo.COVID_INCIDENT;
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractCovidIncident @isRestart = 1;
  end
