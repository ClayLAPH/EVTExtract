create procedure dbo.ExtractSARS2Outbreak 
  @isRestart tinyint = 0
as
begin
  ...
  begin try
    select @rows = count(*) from dbo.SARS2_OUTBREAK;
    select @status = 'ends';
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractSARS2Outbreak @isRestart = 1;
  end
