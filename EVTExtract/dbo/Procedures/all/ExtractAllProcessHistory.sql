create procedure dbo.ExtractAllProcessStatusHistory 
  @isRestart tinyint = 0
as
begin
  ...
  set nocount on;
  declare 
    @name sysname = 'ALL_PROCESS_STATUS_HISTORY',
  ...
  begin try
    ...
    truncate table dbo.ALL_PROCESS_STATUS_HISTORY;

    insert dbo.ALL_PROCESS_STATUS_HISTORY 
    (       
      Disease,
    ...
    select 
      ...
      PR_RowID, AUD_ID, AUD_OldValue, AUD_NewValue, AUD_ActionDate, AUD_Username
    from 
      dbo.ALL_PROCESS_STATUS_HISTORY_VIEW
    option
  ...
  begin
    waitfor delay '00:01';
    execute dbo.ExtractAllProcessStatusHistory @isRestart = 1;
  end
