create table dbo.SARS2_INCIDENT_ARCHIVE2(
	PR_ROWID int NOT NULL index [SARS2_INCIDENT_ARCHIVE2.PR_ROWID.index],
	PR_PHTYPE varchar(255) NULL,
	PR_LEGACY_ROWID varchar(50) NULL,
	PR_PERSONDR int NULL,
	PR_USERDR int NULL,
	PR_OUTBREAKDRSTEXT varchar(max) NULL,
	PR_INCIDENTID int NOT NULL index [SARS2_INCIDENT_ARCHIVE2.PR_INCIDENTID.index],
