CREATE TABLE dbo.SARS2_UDF_DATA
(
...
go
create clustered index [SARS2_UDF_DATA.SECTION_DEF_DR.FORM_DEF_DR.FIELD_DEF_DR]
on dbo.SARS2_UDF_DATA( SECTION_DEF_DR, FORM_DEF_DR, FIELD_DEF_DR )
go
create index [SARS2_UDF_DATA.RECORD_ID.Fake.PrimaryKey]
on dbo.SARS2_UDF_DATA( RECORD_ID );
