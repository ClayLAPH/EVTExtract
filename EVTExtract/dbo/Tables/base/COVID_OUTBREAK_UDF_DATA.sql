CREATE TABLE dbo.COVID_OUTBREAK_UDF_DATA
(
...
go
create clustered index [COVID_OUTBREAK_UDF_DATA.RECORD_ID.FIELD_DEF_DR]
on dbo.COVID_OUTBREAK_UDF_DATA( RECORD_ID, FIELD_DEF_DR )
