create view dbo.SARS2_INCIDENT_ARCHIVE_VIEW as 
select 
  PR_ROWID, 
  PR_PHTYPE, 
  PR_LEGACY_ROWID, 
  ...
  PR_DISEASECODE_DR, 
  PR_DISTRICTCODE_DR, 
  PR_PROCESSSTATUSCODE_DR, 
  PR_SPACODE_DR, 
  PR_RESOLUTIONSTATUSCODE_DR, 
  PR_NURSEINVESTIGATORDR, 
  PR_SPECIMENTYPE, 
  PR_SPECIMENDATECOLLECTED, 
  PR_SPECIMENDATERECEIVED, 
  PR_SPECIMENRESULT, 
  PR_SPECIMENNOTE, 
  PR_DIAGSPECIMENTYPES, 
  PR_EXPEXPOSURETYPES, 
  PR_HEPATITISDRS, 
  PR_DISEASEGROUPS, 
  PR_RESULTVALUE, 
  ...
  PR_LIPRESULTNOTES, 
  PR_LIPRESULTNAME, 
  PR_HEALTHCAREPROVIDERLOCATIONDR, 
  PR_NOTES, 
  PR_DATEOFDIAGNOSIS, 
  PR_DATEOFDEATH, 
  PR_DATEOFLABREPORT, 
...
where
  ...
  and
  PR_ROWID in ( select distinct DVPR_RowID from internals.Sars2Archive2 )
