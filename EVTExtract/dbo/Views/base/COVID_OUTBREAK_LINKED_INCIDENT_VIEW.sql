create view dbo.COVID_OUTBREAK_LINKED_INCIDENT_VIEW as 
select 
  ob.dvob_rowid,
...
where  
  ob.dvob_rowid in (select DVOB_RowID from [$(PRD_APHIM_UODS)].dbo.DV_Outbreak with (nolock) where DVPR_DiseaseCode_ID IN (543030, 544041)) 
