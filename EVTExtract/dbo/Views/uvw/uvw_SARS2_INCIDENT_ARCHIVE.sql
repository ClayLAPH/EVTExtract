create view uvw_SARS2_INCIDENT_ARCHIVE as 
select
  ...
  ArchiveVersion                          = 1
from
    dbo.SARS2_INCIDENT_ARCHIVE incident inner join dbo.SARS2_PERSON_ARCHIVE person on person.PER_RowID = incident.PR_PersonDR
union all  
select
  person.PER_ClientID                       Person_ID, 
  person.PER_LASTNAME                       Last_Name, 
  ...
  ArchiveVersion                          = 2
from
  dbo.SARS2_INCIDENT_ARCHIVE2 incident inner join dbo.SARS2_PERSON_ARCHIVE2 person on person.PER_RowID = incident.PR_PersonDR
