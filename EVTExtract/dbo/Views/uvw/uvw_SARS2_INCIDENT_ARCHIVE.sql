...
select
  ...
  ArchiveVersion                          = 1
from
  (select * from dbo.SARS2_INCIDENT_ARCHIVE union all select * from dbo.SARS2_INCIDENT_ARCHIVE2) as incident
  inner join
  (select * from dbo.SARS2_PERSON_ARCHIVE union all select * from dbo.SARS2_PERSON_ARCHIVE2 ) as person
  on 
