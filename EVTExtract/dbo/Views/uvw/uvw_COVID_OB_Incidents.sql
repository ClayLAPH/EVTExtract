create view dbo.uvw_COVID_OB_Incidents as
select  
  ...
  try_CONVERT(datetime,O.OUTB_DateCreated) Outbreak_Date_Created, 
  try_CONVERT(datetime,O.OUTB_DateofOnset) Outbreak_Date_of_Onset, 
