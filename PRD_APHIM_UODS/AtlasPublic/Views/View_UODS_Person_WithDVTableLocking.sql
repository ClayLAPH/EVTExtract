...
CREATE VIEW [AtlasPublic].[View_UODS_Person_WithDVTableLocking] 
AS
    SELECT PER.DVPER_ROWID AS PER_ROWID,
       ...
       -- +Mohan ISSUE#179181
       [dbo].[MDF_ATTR_GETSTRINGVALUE_ENTATTR_BYENTITYID]((CASE WHEN  S_Link.ID IS NOT NULL THEN S_Link.Entity2_ID ELSE PER.DVPER_RowID END),'VALUESTRING','PSNID_EMAILID') AS  PER_EMAIL,
       [dbo].[MDF_ATTR_GETSTRINGVALUE_ENTATTR_BYENTITYID]((CASE WHEN  S_Link.ID IS NOT NULL THEN S_Link.Entity2_ID ELSE PER.DVPER_RowID END),'VALUESTRING','PSNID_ELECTRONICCONTACT') AS  PER_ELECTRONICCONTACT,
       -- -Mohan ISSUE#179181
