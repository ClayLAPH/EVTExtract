/****** Object:  View [AtlasPublic].[View_UODS_GetInvestigationAddonData]    Script Date: 01/27/2014 11:42:15 ******/
CREATE VIEW [AtlasPublic].[View_UODS_GetInvestigationAddonData]  
AS 
-- Get the Investigation Add On Section Data
...
FROM CTE_PHDATEFIELDFORMAT,
	...
	INNER JOIN A_Act SecAct (NOLOCK) ON SecAct.ID = VSEC.UDSectionActID 
			AND (SecAct.code_ID = VCPDis.DIS_InvestigationUDSectionDR)
