...
create view [covid].[SARS2_OUTBREAK_LINKED_INCIDENT]
as
SELECT 
...
[v_unifiedcodeset].[conceptcode] [concatendated]
       ...
       WHERE  ( [dv_outbreak].[dvob_rowid] in (select DVOB_RowID from DV_Outbreak where DVPR_DiseaseCode_ID IN (544041)) )
