CREATE TABLE [covid].[COVID_INCIDENT] (
...
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20200730-083906]
    ON [covid].[COVID_INCIDENT]([PR_INCIDENTID] ASC);


GO
ALTER INDEX [NonClusteredIndex-20200730-083906]
    ON [covid].[COVID_INCIDENT] DISABLE;
