...
CREATE VIEW [AtlasInternal].[VIEW_ClientRecord_MultipleIdentities_CMMode]
AS
SELECT
	DVPER.DVPER_ROWID AS [IDE_PATIENTID],
	DVPER.DVPER_NCMID AS [IDE_CLIENTID],
	ENTITY_PSN.ID AS [IDE_IDENTITYID],
	...
	[DBO].[MDF_ENTTELECOM_ADDRESS_ENTITY_BYENTITYID](ENTITY_PSN.ID, 'MC', 'TEL') AS [IDE_CELLPHONE],
